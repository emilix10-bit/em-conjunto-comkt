...
# Convocação de Remanescentes no Compras.gov.br

Utilize o Compras.gov.br para formalizar e gerenciar convocações de remanescentes em seus processos de contratação homologados.

---

<span style="font-size: 1.5em; font-weight: bold;">Formatos de Visualização</span>

Você pode acessar as etapas específicas que deseja consultar ou ver o manual completo, com todas as seções. Para isso, selecione o menu ao lado ou os links abaixo:
